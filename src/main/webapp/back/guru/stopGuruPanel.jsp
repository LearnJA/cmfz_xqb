...
<script>
    $(function(){
        $("#stopGurutabs").edatagrid({
            url:'${pageContext.request.contextPath}/guru/findGurus.do?status=0',
            fitColumns:true,//自适应整个容器
            toolbar:'#toolstopguru',//添加顶部工具栏
    ...
    /*添加*/
    function add(){
        $("#stopGurutabs").edatagrid('addRow',0);
        //$("#gurutabs").edatagrid('reload');
    }

    /*删除*/
    function del(){
        $("#stopGurutabs").edatagrid('destroyRow');
       // $("#gurutabs").edatagrid('reload');
    }
    /*上传头像*/
...
<div id="guruPanel" style="margin-left:5px;width:95%;height:95%;">
    <table id="stopGurutabs" style="width:600px;height:200px" title="上师列表" singleSelect="true">
        <thead>
        <tr>
